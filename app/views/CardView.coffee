class window.CardView extends Backbone.View
  ...
  imgLookup:
    ...
    'Jack of Spades' : './svg/jack_of_spades.svg'
    'Queen of Spades' : './svg/queen_of_spades.svg'
    'King of Spades' : './svg/king_of_spades.svg'
    ...
    'Jack of Diamonds' : './svg/jack_of_diamonds.svg'
    'Queen of Diamonds' : './svg/queen_of_diamonds.svg'
    'King of Diamonds' : './svg/king_of_diamonds.svg'
    ...
    'Jack of Hearts' : './svg/jack_of_hearts.svg'
    'Queen of Hearts' : './svg/queen_of_hearts.svg'
    'King of Hearts' : './svg/king_of_hearts.svg'
    ...
    'Jack of Clubs' : './svg/jack_of_clubs.svg'
    'Queen of Clubs' : './svg/queen_of_clubs.svg'
    'King of Clubs' : './svg/king_of_clubs.svg'
